...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public ResponseDto createUser(UserDto user) throws Exception {
        ...
        //generate token
        String accessToken = JWTUtils.generateToken(storedUserDetails.getEmail());

        ResponseDto returnedValue = modelMapper.map(storedUserDetails, ResponseDto.class);
